...
export default function Modal({ open, onClose, Content }: I_Modal) {
    if (!open) return null;
    return (
                    ...
                    <div className="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full">
                        {
                            ...
                            <div className="sm:flex sm:items-start">
                                <div onClick={onClose} className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10">
